...
def main(params):
    ...
    if params['split'] == 1:
        output_dir = 'data_train_val'
    elif params['split'] == 2:
        output_dir = 'data_train-val_test'
    elif params['split'] == 3:
        output_dir = 'data_train-val_test-dev'
    output_dir = output_dir + '_%dk'%(params['num_ans']/1000)
    os.system('mkdir ' + output_dir)

    input_train_json = 'data/vqa_raw_s%d_train.json'%params['split']
    input_test_json = 'data/vqa_raw_s%d_test.json'%params['split']
    output_name = '%s/data_prepro'%output_dir
    if params['subset'] == 'True':
        ...
        output_name = '%s/data_prepro_sub'%output_dir
    ...
    # create output h5 file for testing set.
